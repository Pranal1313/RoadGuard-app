      ...
      <ScrollView contentContainerStyle={ui.scroll}>
        ...
        <View style={ui.logoWrapper}>
          ...
          <Text style={ui.subtitle}>
            AI Pothole Detection & Reporting
          </Text>
        </View>
        ...
        <Text style={ui.footer}>
          Protected by AI verification system
        </Text>
      </ScrollView>
    </LinearGradient>
  );
