...
import { ChevronLeft, Award, CreditCard, Edit, LogOut } from 'lucide-react-native';
...
export default function UserProfile() {
  ...
  const loadUserData = async () => {
    ...
    try {
      ...
      // Hide reports officially closed by admin
      setReports(loadedReports.filter((r) => !r.repairedClosed));
    } catch (err) {
                ...
                <View style={{ flex: 1, marginLeft: 12 }}>
                  ...
                  <Text style={[
                    ...
                    report.creditsAwarded ? styles.creditAwarded
                      : report.creditEligible ? styles.creditPending
                      : styles.creditNone
                  ]}>
...
const styles = StyleSheet.create({
  ...
  avatar: {
    ...
    backgroundColor: '#1077a3', alignItems: 'center', justifyContent: 'center',
  },
